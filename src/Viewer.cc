...
void Viewer::Run()
{
    ...
    pangolin::CreateWindowAndBind("Dynamic-Objects-Filtering-SLAM: Map Viewer",1024,768);
    ...
    cv::namedWindow("Dynamic-Objects-Filtering-SLAM: Current Frame");
    ...
    while(1)
    {
        ...
        cv::imshow("Dynamic-Objects-Filtering-SLAM: Current Frame",im);
        cv::waitKey(mT);
